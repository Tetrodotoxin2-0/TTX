# I'm Tetrodotoxin 2.0
# Team Tetrodotoxin
# Facebook :~ https://facebook.com/Tetrodotoxin2.0

PROMPT=$'
%{\e[0;34m%}%B┌─[%b%{\e[0m%}%{\e[1;32m%} Tetrodotoxin 2.0%{\e[1;33m%}@%{\e[0m%}%{\e[0;36m%}termux%{\e[0;34m%}%B]%b%{\e[0m%}-%{\e[0;34m%}%B[%b%{\e[0;33m%}$(get_date)%{\e[0;34m%}%B]%b%{\e[0m%}-%{\e[0;34m%}%B[%b%{\e[1;33m%}$(get_time)%{\e[0;34m%}%B]%b%{\e[0m%}
